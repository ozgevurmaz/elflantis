...
import { YEDI_GUNLUK_JOURNEY_CARDS, YEDI_GUNLUK_JOURNEY_CONTENT } from "@/lib/constants";
    ...
    <section className="px-6 py-20 lg:px-8 lg:py-28">
        ...
        >
          <h2 className="font-display text-3xl tracking-tight text-ink-900 sm:text-4xl">
            {YEDI_GUNLUK_JOURNEY_CONTENT.title}
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-ink-700">
            {YEDI_GUNLUK_JOURNEY_CONTENT.description}
          </p>
        </motion.div>

        <div className="mt-12 grid gap-5 sm:grid-cols-2">
          {YEDI_GUNLUK_JOURNEY_CARDS.map((card, index) => {
